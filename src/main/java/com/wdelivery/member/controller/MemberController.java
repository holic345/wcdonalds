...
public class MemberController {
	...
	public QnaVO qna(QnaVO qnaVO, @RequestParam(name = "qa_email", defaultValue = "1") String qa_email,
			@RequestParam(name = "qa_password", defaultValue = "1") String qa_password, Model model) {
		System.out.println("controller\n email => " + qa_email);
		System.out.println("password => " + qa_password);
		QnaVO vo = qnaServie.qnaSelect(qnaVO);

		// if(qnaVO.getQa_email().equals(qa_email)||
		// qnaVO.getQa_password().equals(qa_password)) { //db쩔징 쩐첩�쨩 쩍횄
