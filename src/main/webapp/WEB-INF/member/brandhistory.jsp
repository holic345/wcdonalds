...
<div id="container">
		...
		<div class="visualArea bgStory01" data-title="브랜드 소개" data-desc="브랜드 소개">
				...
				<div class="contArea">
					<div class="inner">
						<ul class="tabType01">
							<li><a href="brandintro.do" role="button" >맥도날드 소개</a></li>
							<li><a href="brandhistory.jsp" role="button" aria-selected="true">맥도날드 철학 및 역사</a></li>
						</ul>
						...
						<div class="brandCont03">
							<div class="col2">
								<img src="resources/img/img_brand02_02.jpg" alt="맥도날드 1호 일리노이주 매장 이미지">
								<div>
									<h3 class="tit">1955년, 일리노이주에 첫 매장 오픈에서 5년 후,<br>200개의 매장 오픈까지</h3>
									<p>크록은 맥도날드 형제에게 미국 전역에 걸쳐 맥도날드 매장을 개장하는 비전을 제시하며프랜차이즈 사업을 제안했습니다. <br>
									1955년에 크록은 일리노이주의 데스플레인스(Des Plaines)에 맥도날드의 첫 정식 프랜차이즈 매장을 오픈했습니다.<br>
									이 후 큰 성공을 거두어 불과 5년 만에 점포 수는 200개가 되었습니다.</p>
									<h3 class="tit">맥도날드의 기업철학의 뿌리, 레이 크록</h3>
									<p>1984년 1월, 81세의 나이로 사망하기 직전까지 크록은 맥도날드를 위해 헌신 했습니다.<br>
									그는 새 가맹점이 문을 열 때마다 영업 첫날의 판매 보고서를 받아 철저히 검토했으며, 맥도날드의 당시 신임 경영진이 어떻게 회사를 이끌어 가는지 늘<br> 
							...
							<div class="col2">
								<div>
									...
									&lsquo;맥도날드를 위해 일하는 것&rsquo;이 아닌, &lsquo;맥도날드와 함께 본인들을 위해<br> 일하는 것&rsquo;이라는 비전을 전달했습니다. 
									크록은 &lsquo;사업은 혼자 하는것이 아니라<br>(by yourself), 본인을 위해하는 것(for yourself)이다&rsquo;라는 유명한 슬로건을 남긴 바 있습니다.
									<br>크록의 신념은 프랜차이즈 파트너, 공급업체가 의자의 세 다리와 같은 역할을<br> 해야만 맥도날드가 튼튼하게 바로설 수 있다는 의미의 &lsquo;세 다리 의자<br>
									(The Three-Legged Stool)&rsquo; 철학을 바탕으로 하고 있습니다.<br> 이것이 맥도날드가 오늘날의 프랜차이즈 표본이 되고,60년 가까이 전세계에서<br> 
