(function () {/*VERSION:210803*/
    function checkWebviewCustomUA(a) {
        for (var b = [
            "daum", "naver", "google", "facebook", "twitter"
        ], c = !1, d = 0, e = b.length; e > d; d++) 
            if (a.indexOf(b[d]) > -1) {
                c = !0;
                break
            }
                ...
                case "object":
                    ...
                    if (rep && "object" == typeof rep) 
                        for (f = rep.length, c = 0; f > c; c += 1) 
                            "string" == typeof rep[c] && (d = rep[c], e = str(d, i), e && g.push(
                                quote(d) + (
                                    gap
                                        ? ": "
                                        : ":"
                        ...
                        for (d in i) 
                            Object
                                .prototype
                                .hasOwnProperty
                                .call(i, d) && (e = str(d, i), e && g.push(quote(d) + (
                                    gap
                                        ? ": "
                                        : ":"
                                ) + e));
    ...
    postcodeUtils.isAvailable = function (a) {
        return postcodeUtils.isUndefined(a) || postcodeUtils.isNull(a) || "" === postcodeUtils.trim(
            a
        )
            ? !1
            : !0
    ...
    postcodeUtils.userAgent = function (a) {
        function b(a) {
            var b = {},
                d = /(dolfin)[ \/]([\w.]+)/.exec(a) || /(chrome)[ \/]([\w.]+)/.exec(a) || /(webkit)(?:.*version)?[ \/]([\w.]*)/.exec(
                    a
                ) || /(opera)(?:.*version)?[ \/]([\w.]+)/.exec(a) || /(msie) ([\w.]+)/.exec(a) || a.indexOf(
                    "compatible"
                ) < 0 && /(mozilla)(?:.*? rv:([\w.]+))?.*firefox/.exec(a) || /(rv):([\w.]+)/.exec(
                    a
                ) || ["", "unknown"];
            return "webkit" === d[1]
                ? d = /(iphone|ipad|ipod)[\S\s]*os ([\w._\-]+) like/.exec(a) || /(android)[ \/]([\w._\-]+);/.exec(
                    a
                ) || [
                    d[0], "safari", d[2]
                ]
    ...
    postcodeUtils.isIOSWebview = function (a) {
        for (var b = [
            ...
            "version/14",
            "version/15"
        ], c = 0, d = 0, e = b.length; e > d; d++) 
            -1 === a.indexOf(b[d]) && c++;
        return c === b.length
            ? !0
            : checkWebviewCustomUA(a)
    },
        ...
        a.viewUtils = function () {
            function b(a, b, d, e, f, h) {
                "msie" !== g.browser.name || 7 !== parseInt(g.browser.version.major, 10) || c.postMessage
                    ? "msie" !== g.browser.name || 6 !== parseInt(g.browser.version.major, 10) || c.postMessage || (
                        h += 60,
            ...
            function p(a) {
                var b = "msie" === f.userAgent.browser.name && 7 === parseInt(
                    ...
                    10
                ) || "msie" === f.userAgent.browser.name && 10 === parseInt(
                    f.userAgent.browser.version.major,
                    10
                );
                if (b) 
        ...
        a.common = function () {
            ...
            function g(a, d, e) {
                !c.postMessage || "function" != typeof c.postMessage && "object" != typeof c.postMessage
                    ? (a.name = "", clearInterval(e.timer), e.timer = setInterval(function () {
                        try {
                            if ("" !== a.name) {
                                var c = a.name,
                                    g = f.decodeData(c),
                                ...
                                d(i, j),
                                a.name = "",
                                "done" === i && e.autoClose && e.onComplete !== h.EMPTY_FUNCTION && (
                    ...
                    : (
                        ...
                        a.customMessageHandler = function (c) {
                            var g = c.data,
                                ...
                                k = b(i);
                            d(j, k),
                            "done" === j && e.autoClose && e.onComplete !== h.EMPTY_FUNCTION && f
                                .event
                                .off(a, "message", a.customMessageHandler)
                        },
        ...
        a.frame = function () {
            function a(a) {
                var b = {
                    ...
                    c = {
                        ...
                        sm: a.submitMode
                            ? "on"
                            : "off",
                        a51: f.userAgent.os.android && f.isAndroidWebview(f.userAgent.ua_string) && f
                            .userAgent
                            .ua_string
                            .indexOf("android 5.1") > -1
                                ? "on"
                                : "off"
                    };
                ...
                var d = q + "&" + f.getStringByOptions(c, "=", "&"),
                    ...
                    i = '<iframe frameborder="0" title="우편번호검색프레임" id="' + j.setId(
                        "viewerFrame",
                        a.viewerNo
                    ) + '" src="' + h.getValidationUrl(d, e, g) + '" style="' + f.getStringByOptions(
                        b,
                        ":",
                        ";"
                    ) + '"></iframe>';
                ...
                j.setReady(f, function (a, i) {
                    if ("reload" === a) {
                        if (b.focus(), f && f.document) {
                            var k = f
                                .document
                                .getElementById(j.getId("viewerFrame", d.viewerNo));
                            k && k.focus()
                        }
                    } else 
                        "search" === a
                            ...
                            : "resize" === a
                                ...
                                : "done" === a && d.onComplete !== g.EMPTY_FUNCTION && setTimeout(function () {
                                    d.onComplete(i),
                                    d.autoClose && (
            ...
            function n(b, c) {
                    ...
                    if (e) {
                        ...
                        l
                            ...
                            : (
                                ...
                                k.name = "viewport",
                                k.content = "user-scalable=no,initial-scale=1.0,maximum-scale=1.0,minimum-scale=1.0,width=d" +
                                        "evice-width",
                                e.appendChild(i),
                                e.appendChild(k)
                            )
                ...
                j.setReady(d, function (a, d) {
                    "done" === a
                        ? c.onComplete !== g.EMPTY_FUNCTION && setTimeout(function () {
    ...
    !function (a, b, c, d, e) {
        var f = b,
            g = "msie" === f.userAgent.browser.name && parseInt(
                f.userAgent.browser.version.major,
                10
            ) <= 6;
    ...
    !function (a, b, c, d, e) {
        ...
        function j(a, b) {
            ...
            if (b) {
                var d = b.autoClose;
                void 0 !== d && null !== d && "boolean" == typeof d && (
        ...
        if (!m) 
            return void alert(
                "[우편번호 서비스] API 로딩 오류가 발생하였습니다. 확인 바랍니다. 지속적인 오류 발생시 ( https://github.com/daumP" +
                "ostcode/QnA/issues ) 이슈 등록 부탁드립니다."
            );
        var n = function (a) {
            ...
            return function (a, d) {
                return b
                    ? !1
                    : (f(d, 3), a && (c = setInterval(function () {
                        f(d, 3)
                    }, 6e5)), !0)
            }
        }(m);
        n(
            !0,
            "[우편번호 서비스 로딩 오류] API 로딩시 허용되지 않는 파라미터가 감지되었습니다. 사이트 관리자(개발자)분께서는 가이드페이지( https" +
                    "://postcode.map.daum.net/guide )의 기본 사용법을 참고하시어 수정 부탁드립니다."
        );
        var o = b,
            p = a.CONT,
            q = a.MODEL,
        ...
        l.prototype = {
            open: function (a) {
                if (!n(
                    !1,
                    "[우편번호 서비스] API 로딩시 허용되지 않은 파라미터가 감지되어 API 작동이 중지되었습니다. 사이트 관리자분께서는 가이드페이지( htt" +
                            "ps://postcode.map.daum.net/guide )의 기본 사용법을 참고하시어 수정 부탁드립니다."
                )) {
