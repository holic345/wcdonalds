...
+ function (a) {
    ...
    b.prototype.pause = function (b) {
        ...
        this
            .$element
            .find(".next, .prev")
            .length && a.support.transition.end && (
    ...
    b.prototype.hide = function (b) {
        ...
        this.isShown && !b.isDefaultPrevented() && (
            ...
            a.support.transition && this.$element.hasClass("fade")
                ? this.$element.one(a.support.transition.end, a.proxy(this.hideModal, this)).emulateTransitionEnd(
                    300
                )
                : this.hideModal()
        )
    ...
    b.prototype.enter = function (b) {
        var c = b instanceof this.constructor
            ? b
            : a(b.currentTarget)[this.type](this.getDelegateOptions()).data(
                "bs." + this.type
            );
