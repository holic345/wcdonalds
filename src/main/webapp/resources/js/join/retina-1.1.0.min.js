...
(function () {
    ...
    Retina.isRetina = function () {
        var mediaQuery = "(-webkit-min-device-pixel-ratio: 1.5),                      (min--moz-device-p" +
                "ixel-ratio: 1.5),                      (-o-min-device-pixel-ratio: 3/2),      " +
    ...
    function RetinaImage(el) {
        ...
        this
            .path
            .check_2x_variant(function (hasVariant) {
                if (hasVariant) 
                    that.swap()
            })
    }
    ...
    RetinaImage.prototype.swap = function (path) {
        ...
        function load() {
            if (!that.el.complete) {
                ...
                that
                    .el
                    .setAttribute("width", that.el.offsetWidth);
                that
                    .el
                    .setAttribute("height", that.el.offsetHeight);
                that
                    .el
