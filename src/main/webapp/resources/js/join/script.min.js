...
$(document).ready(function () {
    ...
    $(".colour-switcher a").click(function () {
        ...
        t !== e
            ? $("#colour-scheme").attr("href", "css/colour-" + t + ".css?x=" + n)
    ...
    jQuery().popover && $("body").popover(
        {selector: "[data-toggle=popover]", container: "body", trigger: "hover"}
    );
        ...
        var e = {
                ...
                start: function (e) {
                    ...
                    e
                        ...
                        .each(function () {
                            $(this).css("visibility", "hidden");
                            $(this).data("animate-delay") && $(this).addClass(
                                $(this).data("animate-delay")
                            );
                            $(this).data("animate-duration") && $(this).addClass(
                                $(this).data("animate-duration")
                            );
                            $(this)
                                .css("visibility", "visible")
                                .addClass("animated")
    ...
    $("[data-js=quicksand]").each(function () {
        ...
        e.click(function (s) {
            ...
            $(this)
                ...
                .addClass("active");
            r === "all"
                ? i = n.find("[data-quicksand-id]")
                : i = n.find('[data-quicksand-tid="' + r + '"]');
            t
                .quicksand(i, {
                    duration: 600,
