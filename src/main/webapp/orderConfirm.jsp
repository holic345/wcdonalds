...
<script type="text/javascript"
	src="https://www.mcdelivery.co.kr/kr//static/1634720129356/assets/00/js/vendor/jquery.min.js"></script>
<script type="text/javascript"
	src="https://www.mcdelivery.co.kr/kr//static/1634720129356/assets/00/js/vendor/modernizr.min.js"></script>
<script src="//c.webtrends.com/acs/account/gta5ia2294/js/wt.js"></script>
<script>!function(a){var e="https://s.go-mpulse.net/boomerang/",t="addEventListener";if("False"=="True")a.BOOMR_config=a.BOOMR_config||{},a.BOOMR_config.PageParams=a.BOOMR_config.PageParams||{},a.BOOMR_config.PageParams.pci=!0,e="https://s2.go-mpulse.net/boomerang/";if(window.BOOMR_API_key="A43HB-T5VX7-84HAN-NCYVB-48HKR",function(){function n(e){a.BOOMR_onload=e&&e.timeStamp||(new Date).getTime()}if(!a.BOOMR||!a.BOOMR.version&&!a.BOOMR.snippetExecuted){a.BOOMR=a.BOOMR||{},a.BOOMR.snippetExecuted=!0;var i,_,o,r=document.createElement("iframe");if(a[t])a[t]("load",n,!1);else if(a.attachEvent)a.attachEvent("onload",n);r.src="javascript:void(0)",r.title="",r.role="presentation",(r.frameElement||r).style.cssText="width:0;height:0;border:0;display:none;",o=document.getElementsByTagName("script")[0],o.parentNode.insertBefore(r,o);try{_=r.contentWindow.document}catch(O){i=document.domain,r.src="javascript:var d=document.open();d.domain='"+i+"';void(0);",_=r.contentWindow.document}_.open()._l=function(){var a=this.createElement("script");if(i)this.domain=i;a.id="boomr-if-as",a.src=e+"A43HB-T5VX7-84HAN-NCYVB-48HKR",BOOMR_lstart=(new Date).getTime(),this.body.appendChild(a)},_.write("<bo"+'dy onload="document._l();">'),_.close()}}(),"".length>0)if(a&&"performance"in a&&a.performance&&"function"==typeof a.performance.setResourceTimingBufferSize)a.performance.setResourceTimingBufferSize();!function(){if(BOOMR=a.BOOMR||{},BOOMR.plugins=BOOMR.plugins||{},!BOOMR.plugins.AK){var e=""=="true"?1:0,t="",n="onoj2ptijkle6ylxyfxa-f-52359e608-clientnsv4-s.akamaihd.net",i="false"=="true"?2:1,_={"ak.v":"32","ak.cp":"439424","ak.ai":parseInt("281094",10),"ak.ol":"0","ak.cr":16,"ak.ipv":4,"ak.proto":"h2","ak.rid":"3c655a5","ak.r":23484,"ak.a2":e,"ak.m":"dspx","ak.n":"essl","ak.bpcip":"115.92.157.0","ak.cport":62303,"ak.gh":"23.44.173.47","ak.quicv":"","ak.tlsv":"tls1.3","ak.0rtt":"","ak.csrc":"-","ak.acc":"","ak.t":"1635238254","ak.ak":"hOBiQwZUYzCg5VSAfCLimQ==","ak.pv":"43","ak.dpoabenc":"","ak.tf":i};if(""!==t)_["ak.ruds"]=t;var o={i:!1,av:function(e){var t="http.initiator";if(e&&(!e[t]||"spa_hard"===e[t]))_["ak.feo"]=void 0!==a.aFeoApplied?1:0,BOOMR.addVar(_)},rv:function(){var a=["ak.bpcip","ak.cport","ak.cr","ak.csrc","ak.gh","ak.ipv","ak.m","ak.n","ak.ol","ak.proto","ak.quicv","ak.tlsv","ak.0rtt","ak.r","ak.acc","ak.t","ak.tf"];BOOMR.removeVar(a)}};BOOMR.plugins.AK={akVars:_,akDNSPreFetchDomain:n,init:function(){if(!o.i){var a=BOOMR.subscribe;a("before_beacon",o.av,null,null),a("onbeacon",o.rv,null,null),o.i=!0}return this},is_complete:function(){return!0}}}}()}(window);</script>
</head>
<body>
	...
	<script>
(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-KM4PZ8');
</script>
...
/*]]>*/	
				...
				<div
					...
					<p>
						...
						시간이 <span class="text-primary timer session-timer"></span> 분
						남았습니다. 주문을 완료해 주세요!
					</p>
				</div>
					...
					<div class="row row-narrow">
						<div class="col-xs-8">
							<form name="form_my_order" id="form_my_order" role="form"
								...
								action="/kr/submit-order-payment.html">
									...
									<div class="panel-body">
										...
										<section class="panel-section order-remarks">
											<div class="form-group">
												<label for="form_review_order_remarks" class="field-label">
													<h3>배달시요청 사항:</h3>
												</label> 
								...
								<input type="hidden" name="csrfValue" value="866bbf7cd161887a755d200e779a9195" />
							</form>
						</div>
						<div class="col-xs-4">
										...
										<table class="table-default table-delivery-address">
											<tbody>
												<tr>
													...
													<td><div>서울특별시 종로구 묘동 56-0 단성사 ㅎ</div></td>
												</tr>
											</tbody>
										</table>
									</section>
	...
	<div id="signin" class="modal-login modal fade signin-modal"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<img class="logo"
						src="https://www.mcdelivery.co.kr/kr//static/1634720129356/assets/82/img/mcdelivery_logo_ko.jpg"
						alt="" />
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true">
						<i class="fa mcd mcd-close"></i>
										...
										<fieldset class="form-credentials">
											...
											<div class="checkbox">
												<input type="checkbox" name="rememberMe"
													id="modal_login_rememberme" value="true" /><input
													type="hidden" name="_rememberMe" value="on" /> <label
													for="modal_login_rememberme" class="checkbox-label">자동
													로그인</label>
											</div>
										</fieldset>
						...
						<fieldset class="fieldset fieldset-deliveryaddress">
							...
							<div class="form-group">
								<select class="hide-default-error" name="address"
									id="form_deliveryoptions_address">
									<option value="1">서울특별시 금천구 시흥동 1026-0 남서울힐스테이트아파트
										213동 205호</option>
									<option value="2">서울특별시 종로구 묘동 56-0 단성사 ㅎ</option>
								</select> <a class="action-secondary action-link" href="/kr/address.html"><i
							...
							<div class="form-group">
								<div class="radio">
									<input type="radio" value="now"
										...
										<label class="radio-label" for="form_deliveryoptions_datetime_now">즉시 주문</label>
									<!-- Start:: Code added for conflict between Master & SG Batch 2 Branch -->
								...
								<div class="deliverydatetime-group">
									<div class="form-group deliverydatetime">
										<label class="field-label overlay-sub-label">날짜:</label> 
										<select class="hide-default-error" name="date" id="form_deliveryoptions_date">
									...
									<div class="form-group deliverydatetime">
										<label class="field-label overlay-sub-label">시간:</label> 
										<select class="hide-default-error" name="time" id="form_deliveryoptions_time">
