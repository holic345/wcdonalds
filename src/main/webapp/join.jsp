...
<!DOCTYPE html>
<!-- saved from url=(0044)https://www.mcalba.co.kr/m/appstrap/join.asp -->
<html lang="ko">
<head>
...
<link rel="stylesheet" href="resources/css/join/theme-sytle.min.css"> -->
...
<link rel="shortcut icon"
	href="https://www.mcalba.co.kr/m/appstrap/img/icons/favicon.png">
<link rel="apple-touch-icon-precomposed" sizes="114x114"
	href="https://www.mcalba.co.kr/m/appstrap/img/icons/114x114.png">
<link rel="apple-touch-icon-precomposed" sizes="72x72"
	href="https://www.mcalba.co.kr/m/appstrap/img/icons/72x72.png">
<link rel="apple-touch-icon-precomposed"
	href="https://www.mcalba.co.kr/m/appstrap/img/icons/default.png">
</head>
...
<body class="page page-join">
    ...
    <div class="header">
      <div class="header-inner container">
        <div class="row">
          <div class="col-md-8"> 
			...
			<div class="navbar">
				<div class="js-clingify-placeholder" style="height: 56px;">
					<div class="js-clingify-wrapper js-clingify-locked">
      ...
      - data-toggle="jpanel-menu" = jPanel Menu
							...
							<a class="navbar-btn" data-toggle="jpanel-menu"
								data-target=".navbar-collapse"> <span class="bar"></span> <span
								class="bar"></span> <span class="bar"></span>
							</a>
							<div
								class="visible-xs-block visible-sm-block hidden-md hidden-lg">
								<h1 class="navbar_logo">
									<a href="https://www.mcalba.co.kr/m/"><img
										src="./McDonald&#39;s Crew_files/logo_sh.png" alt="맥도날드 로고"></a>
								</h1>
							</div>
							...
							<div class="navbar-collapse collapse">
								...
								<ul class="nav navbar-nav">
									...
									<li class="dropdown"><a
										href="https://www.mcalba.co.kr/m/appstrap/about.asp"
										class="dropdown-toggle menu-item" id="features-drop"
										data-toggle="dropdown">업무소개 <i
											class="fa fa-sort-asc icon-arrow"></i></a> Dropdown Menu - Mega Menu
										<ul class="dropdown-menu" role="menu"
											aria-labelledby="features-drop">
											<li role="presentation"><a role="menuitem"
												href="https://www.mcalba.co.kr/m/appstrap/about.asp"
												tabindex="-1" class="menu-item">업무소개</a></li>
											<li role="presentation"><a role="menuitem"
												href="https://www.mcalba.co.kr/m/appstrap/chance.asp"
												tabindex="-1" class="menu-item">성장의 기회</a></li>
										</ul></li>
									<li class="dropdown"><a
										href="https://www.mcalba.co.kr/m/appstrap/recruit_list.asp"
										class="dropdown-toggle" id="about-drop" data-toggle="dropdown">지원하기
											<i class="fa fa-sort-asc icon-arrow"></i>
									</a> Dropdown Menu
										<ul class="dropdown-menu" role="menu"
											aria-labelledby="about-drop">
											<li role="presentation"><a role="menuitem"
												href="https://www.mcalba.co.kr/m/appstrap/recruit_list.asp"
												tabindex="-1" class="menu-item">최신 채용정보</a></li>
											<li role="presentation"><a role="menuitem"
												href="https://www.mcalba.co.kr/m/appstrap/area_list.asp"
												tabindex="-1" class="menu-item">지역정보 검색</a></li>
										</ul></li>
									<li class="dropdown"><a
										href="https://www.mcalba.co.kr/m/appstrap/welfare.asp"
										class="dropdown-toggle" id="about-drop" data-toggle="dropdown">즐거운
											일터 <i class="fa fa-sort-asc icon-arrow"></i>
									</a> Dropdown Menu
										<ul class="dropdown-menu" role="menu"
											aria-labelledby="about-drop">
											<li role="presentation"><a role="menuitem"
												href="https://www.mcalba.co.kr/m/appstrap/welfare.asp"
												tabindex="-1" class="menu-item">복지혜택</a></li>
											<li role="presentation"><a role="menuitem" href="study.asp" tabindex="-1" class="menu-item">외국어 학습 프로그램</a></li>
											<li role="presentation"><a role="menuitem"
												href="https://www.mcalba.co.kr/m/appstrap/cooperation.asp"
												tabindex="-1" class="menu-item">산학 협력 프로그램</a></li>
										</ul></li>
									<li><a
										href="https://www.mcalba.co.kr/m/appstrap/join.asp#login-modal"
										data-toggle="modal" class="menu-item">로그인</a></li>
									<li><a
										href="https://www.mcalba.co.kr/m/appstrap/search_id.asp"
										class="menu-item">아이디/비밀번호 찾기</a></li>
									<li><a href="https://www.mcalba.co.kr/m/appstrap/join.asp"
										class="menu-item">회원가입</a></li>
								</ul>
							</div>
							/.navbar-collapse
						</div>
			...
			<div class="row">
				...
				<!-- <div class="col-md-3 sidebar">
					<div class="section-menu">
						<ul class="nav nav-list">
							...
							<li class="active"><a
								href="https://www.mcalba.co.kr/m/appstrap/join.asp"
								class="first">회원가입<small>Join Us</small><i
				...
				<div class="col-md-9">
					...
					<form name="join_form" method="post" action="memberJoin.jsp">
						...
						<textarea name="textarea" rows="10" class="w100per" readonly=""
							title="이용약관">제1조. 목적

제1조. 목적

이 약관은 한국맥도날드 유한회사 (이하 "회사")가 운영하는 맥딜리버리 인터넷 홈페이지(https://www.mcdelivery.co.kr/kr/, 이하 "홈페이지") 및 휴대용 단말기 또는 태블릿PC 등에서 구현되는 어플리케이션(이하 “어플리케이션”) 이용 서비스와 관련하여 회사 및 회원의 권리, 의무, 책임사항, 기타 이용 조건 및 절차에 관한 사항을 규정함을 목적으로 합니다.
...
회원은 개정된 약관에 동의하지 않을 경우 회원 탈퇴를 요청할 수 있고, 회원이 탈퇴를 하지 않고 계속해서 홈페이지 및 어플리케이션을 
사용하는 등의 서비스를 받는 경우 또는 위 제3조 제2항에 따라 변경된 약관이 공지된 이후 7일의 기간이 경과한 때까지 탈퇴의 의
사를 표시하지 않을 시에는 약관 변경에 대한 동의의 의사를 표시한 것으로 간주됩니다.
...
회사는 관계법령이 정하는 바에 따라 회원의 개인정보를 보호하기 위해 노력합니다. 또한, 개인정보의 보호 및 사용에 대해서는 관계법령뿐 아니라 회사의 개인정보처리방침이 적용됩니다.
회원 가입 시 입력한 개인정보는 회원의 동의를 득하거나 관계법령에서 허용하는 경우를 제외하고는 다른 용도로 사용되지 않으며, 또한 외부로 유출되지 않습니다.
상기 제2항에도 불구하고 회사가 관계법령에 따라 수사기관 등 제3자에 대하여 회원의 개인정보를 제공할 의무를 지게되는 경우, 회사는 관계법령을 준수하는
 범위 내에서는 부득이하게 회원의 개인정보를 제공할 수 있습니다.
...
회원이 스팸메일 발송 등을 위하여 다른 회원들의 e-mail 주소를 사용하거나 이를 제3자에게 제공하였을 경우, 이에 대한 모든 법적 책임은 해당 
회원에게 있으며, 해당 회원은 이로 인하여 발생하는 모든 손실 또는 손해로부터 회사가 면책되도록 하여야 합니다.

제9조. 저작권

회원이 홈페이지 및 어플리케이션에서 제공하는 각종 서비스에 대한 정보를 사전 동의 없이 외부로 유출시켰을 경우, 해당 회원은 저작권법 등 관계법령에 의하여 제재를 받을 수 있습니다.
...
회원이 홈페이지 및 어플리케이션를 이용한 부당광고 및 다른 회원들에게 피해를 주는 행위를 하였을 경우, 회사는 1회에 한하여 해당 
이용자에게 해당 행위를 중지할 것을 통보하며, 통보에도 불구하고 그러한 행위가 지속될 때에는 별도의 통보 없이 해당 이용자의 회사 
회원 자격을 정지 또는 박탈할 수 있습니다.

제11조. 서비스 제공 및 이용

서비스는 회사의 업무상 또는 기술상 특별한 지장이 없는 한, 연중무휴 및 1일 24시간을 원칙으로 합니다.
제1항의 이용시간은 정기 점검 등의 필요로 인하여 회사가 정한 날과 시간에는 예외로 합니다. 단, 부득이한 사유로 인해 서비스를 일시 중지할 경우에는 회사는 가급적 사전에 이를 공지하여야 하나, 불가피한 경우에는 사후 통지로 갈음할 수 있습니다.
...
회사는 이 약관에서 특별히 정한 경우를 제외하고는 이용자의 개인정보를 본인의 승낙 없이 타인에게 누설, 배포하여서는 아니 됩니다. 다만, 정보통신망 이용촉진 및 정보보호 등에 관한 법률 등 관계법령에 의하여 국가기관 등의 적법한 요구가 있는 경우에는 예외로 합니다.
회사는 회원으로부터 제기되는 의견이나 불만이 정당하다고 인정할 경우에는 즉시 처리하여야 합니다. 다만, 즉시 처리가 곤란한 
경우에는 이용자에게 그 사유와 처리일정을 통보 하여야 합니다.
...
본 약관은 2016. 4. 1.부터 적용합니다.
						...
						<div class="form-group mt_5">
							<label for="checkbox1"><input type="checkbox"
								name="checkbox1" id="checkbox1" value="1"> 윈도날드 사이트 이용약관에 동의합니다.</label>
						</div>
						<h4 class="title">지원자의 개인정보 처리에 관한 동의</h4>
						<textarea name="textarea" rows="10" class="w100per"
							title="지원자의 개인정보 처리에 관한 동의">※ 수집하는 개인정보의 항목
&nbsp;&nbsp;•&nbsp;이름, 사진, 생년월일, 성별, 로그인ID, 비밀번호, 자택 전화번호, 자택 주소, 휴대전화번호, 이메일, 자기소개,
&nbsp;&nbsp;서비스 이용기록, 접속 로그, 쿠키, 접속 IP 정보 등
&nbsp;&nbsp;•&nbsp;희망직종, 지원경로, 적성검사 결과 등

※ 개인정보의 수집·이용 목적
&nbsp;&nbsp;•&nbsp;회원관리: 회원제 서비스 이용에 따른 본인확인, 개인 식별, 불량회원의 부정 이용 방지와 비인가 사용 방지,
&nbsp;&nbsp;가입 의사 확인, 만14세 미만 아동 개인정보 수집 시 법정 대리인 동의여부 확인, 불만처리 등 민원처리, 고지사항
&nbsp;&nbsp;전달
&nbsp;&nbsp;•&nbsp;과거 지원이력의 관리, 채용 여부의 결정 및 통지 

※ 개인정보의 보유·이용 기간
&nbsp;&nbsp;•&nbsp;관계 법령의 규정에 따라 귀하의 개인정보를 보존할 의무가 있는 경우가 아닌 한, 회사는 위의 수집 및 이용목적을
&nbsp;&nbsp;달성할 때까지 귀하의 개인정보를 보유 및 이용합니다.
			</textarea>
						<div class="form-group mt_5">
							<label for="checkbox2"><input type="checkbox"
								name="checkbox2" id="checkbox2" value="2"> 개인정보 처리에
								동의합니다.</label>
						</div>
		...
		<div class="container">
			<div class="col-sm-6">
				<ul class="list-inline footer-menu-list">
					<li><a href="https://www.mcalba.co.kr/m/appstrap/join.asp"
						class="color-yellow" style="font-weight: bold; color: #ffcc00;">
					</a> <a
						href="https://www.mcalba.co.kr/m/appstrap/join.asp#privacy-modal"
						data-toggle="modal">개인정보처리방침</a></li>
				...
				<p class="copyright">Copyright © 2015 McDonald's. All Right
					Reserved.</p>
			</div>
			<div class="col-sm-6">
				<div id="toplink">
					<a href="https://www.mcalba.co.kr/m/appstrap/join.asp#top"
						class="top-link">Back To Top <i class="fa fa-chevron-up"></i></a>
				</div>
			</div>
		</div>
	</footer>
	...
	<div class="hidden-elements jpanel-menu-exclude">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<form id="frm" name="frm" method="post"
						action="https://www.mcalba.co.kr/m/appstrap/recruit_list.asp">
		...
		<div class="modal fade" id="search-modal" tabindex="-1" role="dialog"
			...
			<div class="modal-dialog">
                ...
                -->
							<div class="form-group">
								<label for="">매장검색</label><br> <input type="radio"
									name="sp" value="r_name" checked=""> 매장명 &nbsp;&nbsp; <input
									type="radio" name="sp" value="r_address"> 주소<br> <input
									name="sk" id="srchtxt" type="text" class="form-control mt_10">
							</div>
						</div>
						<!-- /.modal-body -->
						<div class="modal-footer ta_c">
							<input type="submit" value="검색" class="btn btn-md btn-red">
							<a href="https://www.mcalba.co.kr/m/appstrap/recruit_list.asp"
								class="btn btn-md btn-default r_reset">초기화</a>
							<button type="button" class="btn btn-default"
								data-dismiss="modal" aria-hidden="true">닫기</button>
						</div>
					</form>
					...
					<div class="modal-body">
						<form id="frm_user" name="form" data-toggle="validator"
							...
							<button type="button" class="btn btn-md btn-red btn-block"
								id="btn_login_user">Login</button>

						</form>
					</div>
					<div class="modal-footer ta_c">
						<div class="btn-group" role="group" aria-label="btn_login_box">
							<a href="https://www.mcalba.co.kr/m/appstrap/join.asp"
								class="btn btn-sm btn-default">회원가입</a> <a
								href="https://www.mcalba.co.kr/m/appstrap/search_id.asp"
								class="btn btn-sm btn-default">ID찾기</a> <a
								href="https://www.mcalba.co.kr/m/appstrap/search_pw.asp"
								class="btn btn-sm btn-default">Password찾기</a>
		...
		<div class="modal fade" id="test-modal" tabindex="-1" role="dialog"
			...
			<div class="modal-dialog">
				<div class="modal-content" id="modal_test">
						...
						<form id="frm_test">
								...
								<div class="panel-body">
									...
									<div>
										<input type="radio" name="ans2" value="0" id="ans2"> <strong>
											...
											드리던 고객을 마저 도운 후 어머니 고객 쪽으로 가서 쏟아진 제품을 치우고 청소를 시작합니다</strong><br>
										<input type="radio" name="ans2" value="1"> <strong>도움을
								...
								<div class="panel-body">
									...
									<div>
										<input type="radio" name="ans4" value="1" id="ans4"> <strong>새로운
											...
											name="ans4" value="1"> <strong>이러한 변화로 인해
											발생할 수 있는 긍정적인 영향에 중점을 둡니다.</strong><br> <input type="radio"
											name="ans4" value="1"> <strong>당신은 어떤 변화에도 잘
											대처할 수 있기 때문에 긍정적으로 생각합니다.</strong><br> <input type="radio"
											name="ans4" value="1"> <strong>변화에 대해 더 편안하게
											느껴질 때까지 가능한 한 모든 것을 알아봅니다.</strong>
									</div>
								</div>
							</div>
							<!-- /question 2 -->
								...
								<div class="panel-body">
									...
									<div>
										<input type="radio" name="ans5" value="1" id="ans5"> <strong>도와주겠다고
											답하고 당신의 업무 스케줄에 동료의 업무를 최대한 반영합니다.</strong><br> <input
											type="radio" name="ans5" value="1"> <strong>도와주겠다고
											답하고 필요하다면 추가 시간을 들여서라도 모든 일을 다 마칠 수 있도록 열심히 일합니다.</strong><br> <input
											type="radio" name="ans5" value="1"> <strong>동료를
											도와주어도 될지 매니저에게 물어보고 알려주겠다고 답합니다.</strong><br> <input type="radio"
											name="ans5" value="0"> <strong>사과하고 이미 당신의
											업무만으로도 버거운 상황이라 도와줄 시간이 없다고 말합니다.</strong><br> <input
											type="radio" name="ans5" value="1"> <strong>도와주겠다고
											답하고 나중에 당신이 도움이 필요하게 되면 동료에게 도움을 요청합니다.</strong><br>
									</div>
								</div>
							</div>
							<!-- /question 3 -->
								...
								<div class="panel-body">
									...
									<div>
										<input type="radio" name="ans8" value="1" id="ans8"> <strong>일정을
											...
											type="radio" name="ans8" value="0"> <strong>모든
											것을 다 완료하지 못하더라도 걱정하지 않습니다.</strong><br> <input type="radio"
											name="ans8" value="1"> <strong>일정을 조율해서 모든
											과제를 적절한 수준 이상으로 완료할 수 있는 시간을 확보합니다.</strong><br> <input
											type="radio" name="ans8" value="1"> <strong>시험과
											과제를 성공적으로 마칠 수 있도록 한꺼번에 여러 일들을 처리합니다.</strong><br>
									</div>
								</div>
							</div>
							<!-- /question 4 -->
								...
								<div class="panel-body">
									...
									<div>
										<input type="radio" name="ans9" value="1" id="ans9"> <strong>회사의
											이미지를 바르게 전달하는데 중요한 부분이므로 옷을 갈아입는다. </strong><br> <input
											type="radio" name="ans9" value="1"> <strong>RGM의
											지시를 따르는 것이 중요하므로 옷을 갈아 입는다. </strong><br> <input type="radio"
											name="ans9" value="1"> <strong>RGM의 요구를 어느
											정도 까지만 따른 다음, RGM이 괜찮다고 하는지 본다.</strong><br> <input type="radio"
											name="ans9" value="0"> <strong>RGM에게 고객은 직원
											복장에 관심 없다고 설명한다.</strong><br>
							...
							<div class="panel panel-success">
								...
								<div class="panel-body">
									<p></p>
									<div>
										<input type="radio" name="ans12" value="1" id="ans12">
										<strong>이 상황이 얼마나 화가 났는지 이해해주며, 다른 영화를 볼 것을 추천해 줍니다.</strong><br>
										<input type="radio" name="ans12" value="1"> <strong>고객에게
											사과하고 해당 영화의 다음 상영 일정을 알려줍니다.</strong><br> <input type="radio"
											name="ans12" value="0"> <strong>정중하게 고객에게
											대기중인 사람들이 있으니 결정을 내려야 한다고 말합니다.</strong><br> <input type="radio"
											name="ans12" value="1"> <strong>손님에게 도움을 줄 수
											있도록 관리자를 불러드리겠다고 말합니다.</strong><br> <input type="radio"
											name="ans12" value="1"> <strong>불행히도 할 수 있는
											방법이 없다고 사과합니다.</strong>
									</div>
								</div>
							</div>
							<!-- /question 6 -->
							...
							<div class="panel panel-success">
								...
								<div class="panel-body">
									<p></p>
									<div>
										<input type="radio" name="ans13" value="1" id="ans13">
										<strong>친구들과 이야기 할 때 불편해서 친구들의 말을 들어 본 적이 없는 것처럼
											행동합니다.</strong><br> <input type="radio" name="ans13" value="1">
										<strong>어쨌든 친구들이 나의 의견을 경청하지 않기 때문에 아무 것도 말하지 않기로
											합니다.</strong><br> <input type="radio" name="ans13" value="0">
										<strong>문제되지 않으니 의견 충돌보다는 친구의 의견에 동의해 줍니다.</strong><br> <input
											type="radio" name="ans13" value="1" id="ans13"> <strong>친구와
							...
							<div class="panel panel-success">
								...
								<div class="panel-body">
									<p></p>
									<div>
										<input type="radio" name="ans16" value="0" id="ans16">
										<strong>도울 수 있는 다른 사람들이 있기 때문에 그것에 대해 상관하지 않습니다.</strong><br>
										<input type="radio" name="ans16" value="1"> <strong>남자에게
											도움이 필요한지 물어봅니다.</strong><br> <input type="radio" name="ans16"
											value="1"> <strong>그의 식료품들을 주우며 도와줍니다.</strong><br>
										<input type="radio" name="ans16" value="1"> <strong>나에게도
							...
							<div class="panel panel-success">
								...
								<div class="panel-body">
									<p></p>
									<div>
										<input type="radio" name="ans18" value="0" id="ans18">
										<strong>어린이의 엄마에게 아이스크림 콘을 새로 사주시겠냐고 물어봅니다.</strong><br>
										<input type="radio" name="ans18" value="1"> <strong>아이스크림
											하나 더 그냥 어린이에게 주면서 더러워진 것에 걱정하지 말라고 말하고는 깨끗하게 치웁니다.</strong><br> <input
							...
							<div class="panel panel-success">
								...
								<div class="panel-body">
									<p></p>
									<div>
										<input type="radio" name="ans19" value="1" id="ans19">
										<strong>나는 새로운 친구들을 사귈 수 있어서 좋습니다.</strong><br> <input
											type="radio" name="ans19" value="1"> <strong>나는
											새로운 기술을 배우고 좋은 교육을 받을 수 있을 것으로 기대합니다.</strong><br> <input
											type="radio" name="ans19" value="1"> <strong>나는
											일자리를 갖는 것이 중요합니다.</strong><br> <input type="radio" name="ans19"
											value="1"> <strong>나는 돈을 벌 수 있기를 기대합니다.</strong><br>
										<input type="radio" name="ans19" value="1"> <strong>맥도날드는
											일하기에 즐거운 곳이라 들었습니다.</strong><br> <input type="radio" name="ans19"
											value="0"> <strong>맥도날드는 늘 일자리가 많습니다.</strong>
									</div>
								</div>
							</div>
							<!-- /question 10 -->
					...
					<div class="modal-footer ta_c">
						<a href="https://www.mcalba.co.kr/m/appstrap/join.asp#"
							class="btn btn-md btn-red" id="test_submit">제출</a>
						<button type="button" class="btn btn-default" data-dismiss="modal"
					...
					<div class="modal-body box-scroll">
						<p>
							...
							정보보호 등에 관한 법률 등 개인정보 보호와 관련된 법령을 준수하고 있습니다. <span
								style="color: #025cca;">&lt;개정 2014.11.17&gt;</span><br>
							회사는 개인정보취급방침을 통하여 회원과, 웹사이트를 통하여 회사가 채용한 Crew(이하 ‘회원’은 웹사이트 회원 중
							Crew를 제외한 일반 회원을 의미합니다)가 제공하는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며,
							개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.<br> 회사는 개인정보취급방침을 개정하는
							경우 웹사이트 공지사항(또는 개별공지)을 통하여 공지할 것입니다.<br> 본 방침은 2012년 4월 1일부터
							시행됩니다.
						</p>
						<h4 class="title">1. 회사가 수집하는 개인정보 항목은 무엇인가요?</h4>
						<p class="help-block">• 회사는 회원의 다음과 같은 정보를 수집·이용하고 있습니다.</p>
							...
							<tbody>
								...
								<tr>
									...
									<td>- 회원 관리: 회원제 서비스 이용에 따른 본인확인, 개인 식별, 불량회원의 부정 이용 방지와
										...
										확인, 불만처리 등 민원처리, 고지사항 전달<br> - 과거 지원이력의 관리, 채용 여부의 결정 및
										통지
									</td>
						...
						<p class="help-block">• 회사는 Crew의 다음과 같은 정보를 수집·이용하고 있습니다.</p>
						<h5>[일반 개인정보]</h5>
						<table class="table table-bordered table-th-grey">
							<tbody>
								<tr>
								...
								<tr>
									...
									<td>- 인사관리 및 업무분배: 채용, 승진, 평가, 보상, 상벌, 부서이동, 배치, 전보, 퇴직,
										교육. 미팅 등<br> - 경력관리: 재직증명서 · 경력증명서 · 퇴직증명서 등 증명서의 발급 및
										해당사실의 확인 등<br> - 급여관리: 기본급, 퇴직금 등의 정산 및 지급<br> -
										복리후생: 휴가 등 근로계약에서 정하는 구성원 복지 관련 사항의 이행<br> - 법규준수/계약이행:
										국민연금 · 건강보험 · 고용보험 · 산재보험 등 사회보험의 가입, 소득세 · 주민세 등 각종 세금의 신고 ·
										납부, 소득세법에 따른 연말정산의 실시 등 회사에 부과되는 법적 · 행정적 의무의 이행<br> -
										보안/연락: 회사 내 시스템의 유지 · 관리, 회사 내에서 발생 가능한 범죄, 비리 등의 예방 및 증거수집,
										연락처 공유와 비상연락망 구축<br> - 분쟁해결: 고객 민원의 처리, 향후 발생 가능한 송 등의
										대비지원자의 신원 및 학력·경력의 확인, 과거 지원이력의 관리, 채용 여부의 결정 및 통지
									</td>
									<td>- 신상정보: 성명, 사진, 생년월일, 성별, 국적, 전화번호, 휴대전화번호, 전자우편주소, 가족
										관련 정보(귀하와의 관계, 성명, 생년월일, 성별, 직업, 동거여부 등), 보훈정보(구분, 등급, 관계),
										지문, 계좌번호<br> - 학력 및 경력: 학력(학교명, 전공, 입학 및 졸업연도, 졸업 여부, 성적
										등), 경력(근무지, 직책, 담당업무, 연봉 및 급여내역, 입사일 및 퇴사일, 근무연한 등), 자격,
										수상/징계내역, 병역사항<br> - 근무관련정보: 입사일, 사번, 근무지, 소속부서, 직위/직책,
										근무일수, 근로계약기간, 재직상태, 고용형태, 채용경로, 월별 근무시간, 교육실시내역, 퇴사일과 퇴직사유,
										휴직기간과 휴직사유<br> - 급여 및 보험: 급여정보(월별 급여정보, 연봉, 개인 Award,
										근속선물비, Tip/Rcip 지급액, 퇴직금 중간정산일 등) 및 사회보험정보(가입상태, 보험증번호, 취득일,
										상실일, 만료일, 경감여부 및 기간, 수급자해당여부, 수급액 등)<br> - 근무태도, 업무성과 등에
										대한 평가<br> - CCTV를 통해 수집되는 영상정보
									</td>
								</tr>
								<tr>
									<td>선택적 정보</td>
						...
						<table class="table table-bordered table-th-grey">
							<tbody>
								...
								<tr>
									<td>필수적 정보</td>
									<td>- 식품위생법 등 관련 법령의 준수<br> - 장애인 고용현황의 신고<br> -
										산재보험 등 산업재해 관련 업무의 처리<br>
									</td>
									<td>- 건강검진결과(신장, 체중, 혈액형, 결핵 · 장티프스 · 전염성피부질환 등 유무<br>
										- 장애관련정보: 장애여부, 장애진단일, 등급, 등록번호<br> - 산업재해 발생시 그로 인한 부상
										관련 정보장애여부, 장애등급
									</td>
								</tr>
							</tbody>
						...
						<p>
							• 회사는 홈페이지 회원가입을 통하여 회원의 정보를 수집합니다.<br> • 회사는 제출받은 이력서 등
							채용서류를 통하여 추가적인 Crew의 정보를 수집합니다.
						</p>
						<h4 class="title">3. 개인정보 보유 및 이용기간은 얼마나 되나요?</h4>
						<p>• 원칙적으로, 회사는 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다. 단,
							회사는 사이트 내 부정행위와 불법행위 방지를 위하여 개인정보 수집 및 이용목적 달성 후에도 3개월간 회원 및
							Crew의 정보를 보존할 수 있습니다.</p>
						<h4 class="title">4. 회원 및 Crew의 개인정보 파기절차 및 방법은 어떻게 되나요?</h4>
						<p>
							• 파기절차<br> 회원 및 Crew가 제공한 정보는 목적이 달성된 후 별도의 DB로 옮겨져 내부 방침 및
							기타 관련 법령에 의한 정보보호 사유에 따라(위 3. 참조) 일정 기간 저장된 후 파기됩니다. 별도 DB로 옮겨진
							개인정보는 법률에 의한 경우가 아니고서는 보유 목적 이외의 다른 목적으로 이용되지 않습니다.<br> •
						...
						<p>
							• 법령의 규정에 의거하거나, 수사 목적으로 법령에 정해진 절차와 방법에 따라 수사기관의 요구가 있는 경우, 또는
							회원 및 Crew가 별도로 동의한 경우 외에는 개인정를 외부에 제공하지 않습니다.<br> • 회사 Crew의
							개인정보 제3자 제공 현황은 다음과 같습니다.
						</p>
						<h5>[일반 개인정보]</h5>
						<table class="table table-bordered table-th-grey">
							<tbody>
								...
								<tr>
									<td>MDS 주문 고객<br>(라이더에 한함)<br>[K&amp;C note:
										계산서의 담당자 마스킹 처리가 가능할 경우 본 항목은 삭제 가능]
									</td>
						...
						<p class="help-block">• 회사는 아래와 같이 개인정보 처리업무를 위탁하고 있습니다. 수탁자나
							위탁하는 업무의 내용이 변경되는 경우 본 처리방침을 통해 공개하겠습니다.</p>
						<h5>[회원 개인정보 관련 업무]</h5>
						<table class="table table-bordered table-th-grey">
							<tbody>
								<tr>
						...
						<table class="table table-bordered table-th-grey">
							<tbody>
								...
								<tr>
									<td>GAP Buster<br> <span style="color: #025cca">&lt;신설
											2014.11.17&gt;</span></td>
						...
						<p>• 회사는 개인정보 처리업무 위탁시 개인정보보호법 등 관계법령의 규정에 따라 위탁업무 수행목적 외
						...
						<h4 class="title">7-1. 회원의 개인정보 관련 권리로는 어떤 것이 있고 그 행사 방법은 어떻게
							되나요?</h4>
						<p>
							• 회원 및 회원의 법정 대리인은 언제든지 등록되어 있는 자신 혹은 당해 만 14세 미만 아동의 개인정보를 조회하거나
							수정할 수 있으며 가입해지를 요청할 수도 있습니다.<br> • 회원 혹은 만 14세 미만 아동의 개인정보
							조회. 수정을 위해서는 ‘개인정보변경’ (또는 ‘회원정보수정’ 등)을 가입해지(동의철회)를 위해서는 ‘회원탈퇴’를
							클릭하여 개인정보의 열람, 정정 또는 회원탈퇴가 가능합니다. 혹은 개인정보관리책임자에게 서면, 전화 또는 이메일로
							연락하시면 지체 없이 조치하겠습니다.<br> • 회원이 개인정보의 오류에 대한 정정을 요청하신 경우에는
							회사는 정정을 완료하기 전까지 당해 개인정보를 이용 또는 제공하지 않습니다. 또한 잘못된 개인정보를 제3자에게 이미
							제공한 경우에는 정정 처리결과를 제3자에게 지체 없이 통지하여 정정이 이루어지도록 하겠습니다.<br> •
							회원 혹은 법정 대리인의 요청에 의해 삭제된 개인정보는 별도의 DB로 옮겨져 내부 방침 및 기타 관련 법령에 의한
							정보보호 사유에 따라(위 4. 참조) 일정 기간 저장된 후 파기됩니다.
						</p>
						<h4 class="title">7-2. Crew의 개인정보 관련 권리로는 어떤 것이 있고 그 행사 방법은
							어떻게 되나요?</h4>
						<p>
							• Crew는 자신의 개인정보의 열람 및 처리정지를 요구할 수 있습니다. 다만 다음의 어느 하나에 해당하는 경우에는
							회사는 해당 사유를 Crew에게 알리고, 처리정지 요구를 거절할 수 있습니다.<br> <span
								style="display: block; margin: 0; padding: 0 0 0 10px;">
								(i) 법률에 특별한 규정이 있거나 법령상 의무를 준수하기 위하여 불가피한 경우<br> (ii) 다른
								사람의 생명 · 신체를 해할 우려가 있거나 다른 사람의 재산과 그 밖의 이익을 부당하게 침해할 우려가 있는 경우<br>
								(iii) 개인정보를 처리하지 아니하면 직원과 약정한 서비스를 제공하지 못하는 등 계약의 이행이 곤란한 경우로서
								직원이 그 계약의 해지 의사를 명확하게 밝히지 아니한 경우
							</span> • Crew는 자신의 개인정보의 오류에 대한 정정 및 삭제를 요구할 수 있습니다. 다만, 다른 법령에서 그
							개인정보가 수집 대상으로 명시되어 있는 경우에는 그 삭제를 요구할 수 없습니다.<br> • Crew가
							개인정보의 오류에 대한 정정 및 삭제를 요청한 경우에는 정정 및 삭제를 완료할 때까지 당해 개인정보를 이용 또는
							제공하지 않습니다. 또한 잘못된 개인정보를 이용 또는 제공한 경우 발견 즉시 지체 없이 수정하겠습니다.<br>
							• 위의 권리는 Crew의 법정대리인이나 위임을 받은 자 등 대리인을 통하여 하실 수 있습니다. 이 경우
							개인정보보호법 시행규칙 별지 제11호 서식에 따른 위임장을 제출하여야 합니다.<br> • Crew는
						...
						<p>
							• 회사는 회원 및 Crew의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 아래와 같이
							개인정보관리책임자를 지정하고 있습니다. 회원 및 Crew의 신고사항에 대해 신속하게 충분한 답변을 드릴 것입니다.<br>
							• 개인정보관리책임자<br> 성명: 김철홍<br> 이메일: Churl.Kim@kr.mcd.com
						</p>
	...
	<!-- <script src="resources/js/join/210803.js"></script>
<script src="resources/js/join/bootstrap.min.js"></script>
<script src="resources/js/join/custom-join.js"></script>
...
<script src="resources/js/join/jquery.ui.datepicker-ko2.js"></script>
<script src="resources/js/join/jquery-migrate-1.2.1.min.js"></script>
<script src="resources/js/join/jquery-ui.js"></script>
<script src="resources/js/join/jRespond.js"></script>
<script src="resources/js/join/postcode.v2.js"></script>
<script src="resources/js/join/retina-1.1.0.min.js"></script>
